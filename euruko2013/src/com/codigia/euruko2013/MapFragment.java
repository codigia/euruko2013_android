    ...
    protected Runnable mDelayedLoad = new Runnable() {
        ...
        public void run() {
            mMap.setOnInfoWindowClickListener(new OnInfoWindowClickListener() {
                ...
                public void onInfoWindowClick(Marker marker) {
                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri
                            .parse("http://euruko2013.org/#venue"));
            ...
            mMarkers.add(mMap.addMarker(new MarkerOptions()
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.ruby_marker))
                    .position(ll).title("Badminton Theater").snippet("The EuRuKo2013 venue!")));
