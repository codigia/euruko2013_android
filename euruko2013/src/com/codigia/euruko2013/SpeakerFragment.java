...
public class SpeakerFragment extends BaseFragment {
    ...
    public void onResume() {
        ...
        if (speakerGithub != null) {
            if (r.githubIdString != null && r.githubIdString.trim().length() > 0) {
                ...
                speakerGithub.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        i.setData(Uri.parse(getString(R.string.url_github) + sp.githubIdString));
                        startActivity(i);
                    }
                });
            } else {
        ...
        if (speakerTwitter != null) {
            if (r.twitterIdString != null && r.twitterIdString.trim().length() > 0) {
                ...
                speakerTwitter.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        Intent i = new Intent(Intent.ACTION_VIEW);
                        i.setData(Uri.parse(getString(R.string.url_twitter) + sp.twitterIdString));
                        startActivity(i);
                    }
                });
            } else {
